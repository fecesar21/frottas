...
import { Truck, ClipboardPlus, ClipboardList, LogOut } from 'lucide-react'
...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      <aside className="w-60 shrink-0 bg-gradient-to-b from-navy-950 to-navy-800 flex flex-col">
