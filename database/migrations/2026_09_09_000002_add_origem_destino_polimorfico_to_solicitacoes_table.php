...
return new class extends Migration
{
    ...
    {
        // Idempotente: uma tentativa anterior pode ter falhado em producao
        // apos o ALTER TABLE (DDL nao e transacional no MySQL), deixando
        // colunas/dados parciais para tras.
        if (! Schema::hasColumn('solicitacoes', 'origem_tipo')) {
        ...
        if (Schema::hasColumn('solicitacoes', 'origem_unidade_id')) {
